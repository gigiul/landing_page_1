...
const Plans = () => {
  return (
    <div className='max-w-[1400px] m-auto grid lg:grid-cols-2 py-16 px-4 gap-4'>
        {/*Left Side*/}
        ...
        <div className='flex flex-col justify-center'>
            ...
            <p className='text-3xl py-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore, illo.</p>
            <p className='pb-6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Fugiat, est amet. Nulla esse numquam labore et rem ad odio maiores!</p>
        <div>
